...
export default async function AgendaPage() {
  ...
  if (laserTreatment) {
    options = await xanoFetch<TreatmentOption[]>(`/treatment_option?treatment_id=${laserTreatment.id}`);
  }

  return <AgendaClient treatments={treatments} initialOptions={options} />;
}
